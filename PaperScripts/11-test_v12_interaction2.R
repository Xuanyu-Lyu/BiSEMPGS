...
conditionNames <- c("r2pgs02", "r2pgs04", "r2pgs08", "r2pgs16")
source("PaperScripts/04-OpenMxFunctions.R")
startingParamList1 <- list(vg1 = rep(.36,4),
						   vg2 = rep(.60,4),
						   am11 = c(rep(0.4,3),.4),
						   am12 = c(.3,0.3,.3,.3),
						   am21 = c(.05,0.05,.05,.05), 
						   am22 = c(rep(0.2,3),.2),
						   f11 = c(rep(0.1,3),0.1),
						   f12 = c(0.2,.2,.2,.2),
						   f21 = c(0.2,.2,.2,.2), 
						   ...
						   rg = rep(0.1,4),
						   re = rep(0.1,4),
						   prop.h2.latent1 = c(.34/.36, .32/.36, .28/.36, .20/.36), 
...
for (condition in 4:4){
	...
	for (iter in 1:300){
	    ...
	    sample_file <- paste0("Data/Paper/test_v12_condition2/", conditionNames[condition],"/samples_iter_empi_", iter, ".tsv")
	...
	for (i in c(1:106, 108:300)){
	    DataPath <- paste0("Data/Paper/test_v12_condition2/", conditionNames[condition],"/samples_iter_empi_", i, ".tsv")
	...
	save_path <- paste0("Analysis/Paper/test_v12_condition2/", conditionNames[condition] ,"_MVN_summary_list_300.rds")
	saveRDS(summary_list, save_path)
    save_path_fixedA <- paste0("Analysis/Paper/test_v12_condition2/", conditionNames[condition] ,"_MVN_summary_list_fixedA_300.rds")
