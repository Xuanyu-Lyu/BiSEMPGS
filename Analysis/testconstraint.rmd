...
startingParamList1 <- list(vg1 = rep(.80,10),
						   vg2 = rep(.40,10),
						   ...
						   rg = rep(.1,10),
						   re = rep(.1,10),
						   prop.h2.latent1 = c(0.2,0,0.5,0,rep(0.5,6)),
						   prop.h2.latent2 = c(0.7,0.7,0,0,rep(0.7,6)))
# a starting parameter list for solving alpha beta and tau
startingParamList2 <- list(vg1 = c(.8,.6,.3,.5,.4,.35),
						   vg2 = c(.2,.7,.4,.6,.75,.2),
...
startingParamList1 <- startingParamList2
